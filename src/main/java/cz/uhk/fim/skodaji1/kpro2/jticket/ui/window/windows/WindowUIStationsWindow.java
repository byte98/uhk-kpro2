...
import cz.uhk.fim.skodaji1.kpro2.jticket.ui.window.tables.WindowUIStationsTableModel;
...
public class WindowUIStationsWindow extends WindowUIWindow
{
    ...
    /**
     * Toolbar with all menu items as tools
     */
    ...
    private void prepareToolBar()
    {
        ...
        JButton addStationTool = new JButton();
        addStationTool.setIcon(new ImageIcon(WindowUI.UI_PATH + "/newitem.png"));
        addStationTool.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e)
            {
                addStationItem.doClick();
            }        
        });
        this.toolBar.add(addStationTool);
        JButton deleteStationTool = new JButton();
        deleteStationTool.setIcon(new ImageIcon(WindowUI.UI_PATH + "/deleteitem.png"));
        deleteStationTool.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e)
            {
                deleteStationItem.doClick();
            }                    
        });
        this.toolBar.add(deleteStationTool);
        JButton saveTool = new JButton();
        saveTool.setIcon(new ImageIcon(WindowUI.UI_PATH + "/saveitem.png"));
        saveTool.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e)
            {
                saveChangesItem.doClick();
            }   
        });
        this.toolBar.add(saveTool);
        super.addToolBar(this.toolBar);
