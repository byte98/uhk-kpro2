...
public abstract class WindowUIWindow extends JFrame
{
     ...
     * @param toolBar Tool bar which will be added
     */
    protected void addToolBar(JToolBar toolBar)
    {
        this.getContentPane().remove(this.topMenu);
        JPanel topPanel = new JPanel();
        topPanel.setLayout(new BoxLayout(topPanel, BoxLayout.Y_AXIS));
        topPanel.add(this.topMenu);
        topPanel.add(toolBar);
        this.getContentPane().add(topPanel, BorderLayout.NORTH);
        this.topMenu.setAlignmentX(Component.LEFT_ALIGNMENT);
