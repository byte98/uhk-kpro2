    ...
    public void handleInput(String input)
    {
        switch (input.toLowerCase())
        {
            case "no":
                ...
                break;
            case "yes":
                cz.uhk.fim.skodaji1.kpro2.jticket.data.Stations.GetInstance().EditStation(cz.uhk.fim.skodaji1.kpro2.jticket.data.Stations.GetInstance().GetStation(this.stationAbbr), this.newStationName, this.newStationAbbr);
