...
public class TextUIDistancesViewStation extends TextUIState
{
    ...
    {
       Station s = cz.uhk.fim.skodaji1.kpro2.jticket.data.Stations.GetInstance().GetStation(data.get("station"));
       if (s != null)
       {
           data.put("station_from", s.getName() + " (" + s.getAbbrevation() + ")");
           data.put("stations_distances_tr", cz.uhk.fim.skodaji1.kpro2.jticket.data.Distances.GetInstance().GenerateDistancesRows(s));
           this.origin = s;
